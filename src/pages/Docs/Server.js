    ...
    const Content = () => {
        return (
            <div>
                ...
                <p>Our full source code can be found here at <a className='docsbtn' href="https://github.com/estuary-ai/mangrove" target="_blank" rel="noreferrer">GitHub</a>.</p>
                ...
                <ol>
                    <li>Install packages&#39; dependencies for Ubuntu 22.04 - Tested on WSL2.
                    ...
                    <li>Install virtual environments manager
                        <a href="https://www.anaconda.com/products/distribution" target="_blank"> Anaconda</a>.
                    </li>
                    <li>Create a python 3.9 virtual environment Using Conda or PDM as follows:
                    ...
                    <li>Using <code>pdm use</code> ensure that pdm is pointing to the correct environment.
                    </li>
                ...
                <h4 id="tips">Tips</h4>
                <ul>
                    <li>Ensure both Mangrove and the client are connected to the same LAN and both the machine running Mangrove and the LAN allow for device-to-device communications.
                    </li>
                    <li>[OPTIONAL] You may refer to the Microsoft WSL documentation on Mirrored Networking <a href="https://learn.microsoft.com/en-us/windows/wsl/networking#mirrored-mode-networking">here</a>.
                    </li>
                </ul>
                <h3 id="xtts">XTTS</h3>
                <ul>
                ...
                <ul>
                    <li><strong>2023</strong>: <strong>University of Southern California (USC)</strong> with <strong>University of Berkley (UCBerkley)</strong>
                    </li>
                    <li><strong>2022</strong>: <strong>University of Southern California (USC)</strong> with <strong>University of Arizona (UA)</strong>.
                    </li>
                </ul>
