    ...
    const Content = () => {
        return (
            <div>
                ...
                <p>Our full source code can be found here at <a className='linkbtnFooter' href="https://github.com/estuary-ai/Estuary-Unity-SDK" target="_blank" rel="noreferrer">GitHub</a></p>
